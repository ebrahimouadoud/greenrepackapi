...
module.exports.sendFacture = (name, email, RnId, nameProduitFacture, totalFacture, dateCreation, adresseClt, telephoneClt) => {
    transport.sendMail({
        from: '<Green Repack>',
        to: email,
        subject: `Green Repack - Facture N : ${RnId}`,
        html: `
        <!DOCTYPE html>
<html>
...
<body>
    ...
    <footer>
        <p>Green Repack – Service − Paiement | <a href="#">greenrepack.com</a></p>
        <p>1007 some street in the woods, Wentworth-Nord, Qc, J0T 1Y0 | Tél. 007-007-7007 | <a
                href="greenrepack152@gmail.com">contact@greenrepack.com</a></p>
    </footer>
</body>
